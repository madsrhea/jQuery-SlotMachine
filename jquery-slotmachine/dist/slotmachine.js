...
var defaults = {
  ...
  auto: 3, // Repeat delay [false||Number]
...
const slotMachines = [ document.getElementById('sq1')
...
const slot1 = new SlotMachine(slotMachines[0], {
  auto: true
});
const slot2 = new SlotMachine(slotMachines[1], {
  auto: true
});
const slot3 = new SlotMachine(slotMachines[2], {
  auto: true
});
const slot4 = new SlotMachine(slotMachines[3], {
  auto: true
});
const slot5 = new SlotMachine(slotMachines[4], {
  auto: true
});
const slot6 = new SlotMachine(slotMachines[5], {
  auto: true
});
const slot7 = new SlotMachine(slotMachines[6], {
  auto: true
});
const slot8 = new SlotMachine(slotMachines[7], {
  auto: true
});
const slot9 = new SlotMachine(slotMachines[8], {
  auto: true
});
